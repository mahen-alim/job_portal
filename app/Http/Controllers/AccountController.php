...
class AccountController extends Controller
{
    ...
    public function profile()
    {
        ...
        return view('front.account.profile', ['profil' => $profil]);
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $profil->designation = $request->designation;
            $profil->mobile = $request->mobile;
            $profil->save();
    ...
    public function updateProfilePic(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'image' => 'required|image|mimes:jpeg,png,jpg,gif|max:2048', // Sesuaikan validasi dengan kebutuhan Anda
        ]);
        ...
        if ($request->hasFile('image')) {
            ...
            // Jika penyimpanan berhasil, kembalikan response dengan status true
            return response()->json([
                'status' => true,
                'errors' => []
            ]);
    ...
    public function createJob()
    {
        ...
        return view('front.post_job.create', [
    ...
    public function processForgotPassword(Request $request)
    {
        ...
        // Pastikan email valid sebelum menghapus token yang ada
        ...
        try {
            ...
            return redirect()->route('account.forgotPassword')->with('error', 'Failed to send reset password email. Please try again later.');
        }
